...
const { validateEmbarcacaoScheme } = require('../middlewares/inputValidator')
...
router.post('/', verifyJWT, validateEmbarcacaoScheme, controller.createEmbarcacao); // /embarcacoes
